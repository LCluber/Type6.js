...
;
$(document).ready(function(){$("#sidebarToggler").on("click",function(){$("#docs-sidebar").hasClass("sidebar-visible")?$("#docs-sidebar").removeClass("sidebar-visible").addClass("sidebar-hidden"):$("#docs-sidebar").removeClass("sidebar-hidden").addClass("sidebar-visible")})}),hljs.initHighlighting();
