window.onload = function() {
  ...
  function draw() {
    ...
    context.beginPath();
    context.arc(p3.getX(), p3.getY(), 4, 0, TYPE6JS.Trigonometry.TWOPI, false);
    context.fill();
    ...
    for(var t = 0; t <= 1 + step; t += step) {
      pFinal.quadraticBezierTo( p0, p1, p3, t );
      context.lineTo(pFinal.getX(), pFinal.getY());
    }
    context.stroke();

    pFinal.quadraticBezierTo( p0, p1, p3, t2 );

    context.fillStyle = "red";
    context.beginPath();
    context.arc(pFinal.getX(), pFinal.getY(), 10, 0, TYPE6JS.Trigonometry.TWOPI, false);
    context.fill();
